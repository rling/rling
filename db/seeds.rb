...
Setting.create(:name=>"allow_user_register_user",:desc_text=>"Should the System allow users to sign up to the website on their own. i.e. Should there be a sign link for the user to execute",:setting_type=>"boolean",:setting_value=>"false")
