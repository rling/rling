...
Setting.create(:name=>"header_website_font_size",:desc_text=>"header website font size",:setting_type=>"integer",:setting_value=>"30")
Setting.create(:name=>"header_website_tag_font_size",:desc_text=>"header website tag font size",:setting_type=>"integer",:setting_value=>"14")
Setting.create(:name=>"header_logo",:desc_text=>"header logo",:setting_type=>"string",:setting_value=>"/images/rling_logo.png")
Setting.create(:name=>"header_website_text",:desc_text=>"header website text ",:setting_type=>"string",:setting_value=>"RLING CMS")
Setting.create(:name=>"header_website_tag_text",:desc_text=>"header website tag text ",:setting_type=>"string",:setting_value=>"Faster CMS for Faster Minds")

Setting.create(:name=>"body_background_color",:desc_text=>"body background color",:setting_type=>"colorbox",:setting_value=>"909090")
...
Setting.create(:name=>"top_bar_link_color",:desc_text=>"top bar link color",:setting_type=>"colorbox",:setting_value=>"FFFFFF")
...
Setting.create(:name=>"header_website_text_color",:desc_text=>"header website text  color",:setting_type=>"colorbox",:setting_value=>"FFFFFF")
Setting.create(:name=>"heading_website_tag_color",:desc_text=>"header website tag color",:setting_type=>"colorbox",:setting_value=>"FFFFFF")

Setting.create(:name=>"menu_bar_background_color",:desc_text=>"menu bar background color",:setting_type=>"colorbox",:setting_value=>"333333")
Setting.create(:name=>"menu_bar_menu_text_color",:desc_text=>"menu bar menu text color",:setting_type=>"colorbox",:setting_value=>"FFFFFF")
Setting.create(:name=>"menu_bar_menu_background_color",:desc_text=>"menu bar menu background color",:setting_type=>"colorbox",:setting_value=>"333333")
Setting.create(:name=>"menu_bar_hover_menu_text_color",:desc_text=>"menu bar hover menu text color",:setting_type=>"colorbox",:setting_value=>"FFFFFF")
Setting.create(:name=>"menu_bar_hover_menu_background_color",:desc_text=>"menu bar hover menu background color",:setting_type=>"colorbox",:setting_value=>"BF2E1B")


Setting.create(:name=>"middle_border_color",:desc_text=>"middle border color",:setting_type=>"colorbox",:setting_value=>"808080")
...
Setting.create(:name=>"footer_background_color",:desc_text=>"footer background color",:setting_type=>"colorbox",:setting_value=>"333333")
