Feature: Category Page
  ...
  Scenario: User adds a new category
    ...
    And I fill in "category_description" with "Object Oriented Programming Language"
  ...
  Scenario: User clicks on Show Page
    ...
    When I press "Show" for "Ruby" on the category index page
  ...
  Scenario: Edit a Category item
    ...
    Then I should see "Editing Ruby" on the edit category page 
