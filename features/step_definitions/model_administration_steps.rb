...
Given /^I have a model_submission with comment in model_submissions index page$/ do
  ...
  @comment_datum = Factory(:comment_datum, :comment_component_id=>@comment_component.id,:comment_submission_id=>@comment_submission.id, :data_value=>"This is very good work by Heurion Consulting.")
end
